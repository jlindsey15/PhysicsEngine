...
//I (Jack Lindsey) did add one method to the end of this...


package org.magnos.MathUtils;
...
public class Vec2
{
	...
	//Not in original file (courtesy of Jack Lindsey)
	
	public  Vec2 perpendicularOf() {
